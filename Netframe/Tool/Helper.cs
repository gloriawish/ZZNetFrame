...
namespace Netframe.Tool
{
	...
	public static class Helper
	{
        ...
        /// <returns></returns>
        public static Msg CreateRecivedCheck(IPEndPoint remote,long pno,int pindex,Config cfg)
        {
            Msg cm = Msg.Create(remote,cfg.HostName, cfg.HostUserName, Commands.RecvConfirm, pno.ToString(), pindex.ToString());
            cm.IsRequireReceive = false;
            cm.PackageNo = Msg.GetRandomNumber();
            return cm;
        }
